...
namespace RosSharp.RosBridgeClient.MessageTypes.Control
{
    public class SingleJointPositionActionFeedback : Message
    {
        ...
        public SingleJointPositionFeedback feedback { get; set; }
        ...
        public SingleJointPositionActionFeedback(Header header, GoalStatus status, SingleJointPositionFeedback feedback)
        {
            this.header = header;
            this.status = status;
