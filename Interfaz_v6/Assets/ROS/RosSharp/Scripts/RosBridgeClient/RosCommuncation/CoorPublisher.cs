...
namespace RosSharp.RosBridgeClient
{
    public class CoorPublisher : UnityPublisher<MessageTypes.CartesianControl.CartesianTrajectory>
    {
        ...
        public void coordenadaUnica()
        {
            ...
            message.points[0].pose.position.x = ((float.Parse(GameObject.Find("Cartesiano/PosX").GetComponent<TMP_Text>().text))*0.01);
            message.points[0].pose.position.y = ((float.Parse(GameObject.Find("Cartesiano/PosY").GetComponent<TMP_Text>().text))*0.01);
            message.points[0].pose.position.z = ((float.Parse(GameObject.Find("Cartesiano/PosZ").GetComponent<TMP_Text>().text))*0.01);
            
            angulos.x = (float.Parse(GameObject.Find("Cartesiano/OriX").GetComponent<TMP_Text>().text));
            angulos.y = (float.Parse(GameObject.Find("Cartesiano/OriY").GetComponent<TMP_Text>().text));
            angulos.z = (float.Parse(GameObject.Find("Cartesiano/OriZ").GetComponent<TMP_Text>().text));
            Quaternion cuaternions = ToQuaternion(angulos);
