...
///////
    ...
    public void AgregarPosicion()
    {
        if (NumPos<poses.Length)
        {
            ...
            //poses[NumPos].transform.position = poses[NumPos].transform.position + new Vector3(0, -30*NumPos , 0);
    ...
    public void BotonEliminar()
    {
        ...
        if ((0<NP)&&(NP<=NumPos))
        {
            ...
            for (int i = NP; i < NumPos; i++)
            {
                ...
                //poses[i-1].transform.position = poses[i].transform.position + new Vector3(0, 30 , 0);
            }
